...
public class PersonTest {
    ...
    public void getBirthday() {
        LocalDate expected = LocalDate.of(1989,1,20);
    ...
    public void setBirthday() {
        LocalDate expected = LocalDate.of(1994,3,16);
        person = new Person();
